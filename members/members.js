...
function displayMember(json){
    ...
    let newDiv = '<div class="memberItem"><img src="user-images/'+username+'.jpg" alt="Image not found" onError="this.onerror=null;this.src=\'user-images/missing.jpg\';"><a href="/members/member.html?'+username+'">'+first_name+' '+last_name+'</a></div>'
